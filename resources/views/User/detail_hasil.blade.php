		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand text-size-24" href="#"><i class="fa fa-list-alt"></i>View Detail Hasil </a>
				</div>
			</div>
		</nav>
	</div>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Hasil Optimasi Periode</h3>
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="col-sm-3 form-control" name="periode" placeholder="Nama" required>
						...
						<div class="panel-body table-responsive table-full">
							...
							<a href="/cetak/{{$data['ahp'][0]->id_user}}"><button type="submit" class="btn btn-success">Cetak</button></a>
						</div>
					</div>
				</div>
			</div>
